...
const Hero = () => {
  return (
    <div
      className="w-full min-h-screen flex items-center bg-gray-300 bg-opacity-40 pt-[120px] bg-cover bg-center"
      style={{
      ...
      <div className="w-[95%] h-full flex flex-col lg:flex-row items-center">
        <div className="max-w-3xl px-6 text-left">
          ...
          <div className="flex space-x-4">
            <motion.button
              className="bg-green-500 font-semibold px-6 py-3 rounded-lg shadow-md"
            ...
            <motion.button
              className="bg-transparent border border-b font-semibold px-6 py-3 rounded-lg hover:border-green-600 hover:text-green-600"
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
