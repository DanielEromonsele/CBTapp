    ...
    >
      <div className="w-[95%] h-full flex items-center justify-between px-6">
        ...
        <Link to="/auth/register">
          <div
            className={`w-[180px] h-[40px] text-[20px] font-semibold bg-red-400 text-white rounded-lg flex items-center justify-center hover:rounded-tr-full hover:rounded-bl-full transition-all duration-600 cursor-pointer hover:scale-105 shadow-md ${
              scrolling ? "bg-white  text-red-700" : "bg-red-600"
            }`}
          >
            Get Started
          </div>
